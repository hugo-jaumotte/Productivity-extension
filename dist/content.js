...
function removeSidebar() {
    const removeElements = () => {
        ...
        const sidebar = document.querySelector('#related, ytd-watch-next-secondary-results-renderer');
        if (sidebar) {
            sidebar.remove();
        }
...
chrome.storage.sync.get({ blockShorts: true, blockSidebar: true }, (settings) => {
